#!/usr/bin/python
# coding: utf-8
from modules.debug_PwnTraverse import DebugPwnTraverse
from modules.banner_PwnTraverse import BannerPwnTraverse
from modules.color_PwnTraverse import ColorPwnTraverse
from modules.thread_PwnTraverse import ThreadPwnTraverse
from modules.request_PwnTraverse import RequestPwnTraverse
from modules.file_PwnTraverse import FilePwnTraverse
__author__ = "ANDRI"
__credits__ = ["odaysec"]
__license__ = "GPL"
__version__ = "0.1"
__maintainer__ = "ANDRI / Bjormungandrk"
__email__ = "github@zerodaysec.org"
__git__ = "https://github.com/odaysec"
...
def cs(_color_str: str):
    return OBJ_ColorPwnTraverse.get(_color_str)
...
def exec_exploit(_target, _exploit: list):
    ...
    try: 
        if _target and _exploit:
            ...
            _protocol = f"{OBJ_RequestPwnTraverse.protocol}://"
            _target_exploit = _target_clear+_exploit_clear
            _protocol_target_exploit = _protocol+_target_exploit
            
            target_url, result, code_http, time_final = OBJ_RequestPwnTraverse.send_request(
...
def exploit(_target: str):
    ...
    try:
        for key in LOCAL_EXPLOIT_LIST:
            ...
            try:
                OBJ_ThreadPwnTraverse.exec_thread(
...
if __name__ == '__main__':
    ...
    OBJ_FileLocal = FilePwnTraverse()
    OBJ_ThreadPwnTraverse = ThreadPwnTraverse()
    OBJ_RequestPwnTraverse = RequestPwnTraverse()
    OBJ_ColorPwnTraverse = dict(ColorPwnTraverse())
    OBJ_Banner = BannerPwnTraverse()
    OBJ_Debug = DebugPwnTraverse()
    ...
    OBJ_RequestPwnTraverse.protocol = 'https' if FORCE_HTTPS else 'http'
